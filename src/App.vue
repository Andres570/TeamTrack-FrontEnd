...
export default {
  ...
  data() {
    return {
      // Carga el rol desde localStorage o usa "member" por defecto
  ...
  watch: {
    // Cuando el rol cambia, actualizamos localStorage
    userRole(newRole) {
  ...
  methods: {
    toggleRole() {
      ...
      window.location.reload(); // Recarga para propagar el nuevo rol
    },
  },
};
</script>
